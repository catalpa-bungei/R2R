...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=True,
        help="Enable model thinking mode in chat template (true/false, default: true)",
    )
...
def process_responses(responses, item_ids, items_data, is_print=False, use_thinking_mode=True):
    ...
    for i, response_content in enumerate(responses):
        ...
        is_finished = not use_thinking_mode

        # Extract reasoning from <think> tags if present
        reasoning_content = ""
        if use_thinking_mode and "</think>" in response_content:
...
def main():
    ...
    try:
        ...
        for i in range(0, len(items), batch_size):
            ...
            prompts, item_ids = prepare_prompts(
                items=batch,
                tokenizer=tokenizer,
            ...
            batch_processed = process_responses(
                ...
                use_thinking_mode=args.enable_thinking,
            )
